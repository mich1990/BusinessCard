...
const descriptionEN = 'Software developer <strong class="special">with many years of experience</strong>, proficient in electronics, <strong class="special">owner of a future classic car</strong>. I like to experiment with new technologies and start new project (already too many on the go).';
